...
screen_size=screen_width,screen_height=384*scale,(208*scale)+(24*4) # 1152,720 8:5
stage_size=stage_width,stage_height=384*scale,208*scale # 1152,624
score_board_rect=\
...
player_size=player_width,player_height=32*scale,32*scale
FPS=60
VOLUME_SFX=0.3
#%%
